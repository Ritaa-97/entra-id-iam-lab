...
Employees are assigned to department security groups. Department groups are then assigned to the applications required by that department.
...
Ava Johnson was used as a validation user for the IT access model.
...
Ava Johnson was added to the IT security group, and the IT security group was assigned to the Arkham IT Portal.

This demonstrates the intended group-based access model.
...
1. Enterprise applications configured in Microsoft Entra ID
2. Department security groups
3. IT department group membership
4. IT group-to-application assignment
